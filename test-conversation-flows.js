...
const testScenarios = [
  {
    ...
    expectedFlow:
      "safety_check → stress_level → breathing_activity → breathing_return → location_check → family_check → positive_coping → ongoing_support → breathing_activity",
  },
...

  {
    ...
    expectedFlow:
      "safety_check → safety_clarify → stress_level → location_check → social_check → isolation_support → virtual_connection → ongoing_support → continued_conversation",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → location_check → family_check → positive_coping → social_check → group_coping → leadership_role → ongoing_support → positive_ending",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → location_check → social_check → group_coping → helper_role → breathing_activity",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → grounding_activity → grounding_return → social_check → ongoing_support",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → location_check → family_check → separation_support → communication_check → uncertainty_coping → grounding_activity",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → location_check → family_check → communication_check → relief_processing → ongoing_support",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → location_check → social_check → isolation_support → solitude_strength → ongoing_support",
  },

  {
    ...
    expectedFlow:
      "safety_check → stress_level → location_check → social_check → group_coping → ongoing_support → continued_conversation → stress_level",
  },
];
